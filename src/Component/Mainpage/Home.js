          ...
          <header className="main-slider  has-horizontal p-relative w-100 h-100-v dsn-header-animation">
            <div className="content-slider p-relative w-100 h-100 over-hidden v-dark-head">
                      ...
                      <div className="slide-content p-absolute ">
                        <div className="content p-relative">
                          ...
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project1.html" className="effect-ajax" data-dsn-ajax="slider">Maybe speaker </a>
                          </h1>
                          <hr className="mt-20" />
                    ...
                    <div className="slide-item swiper-slide over-hidden">
                      ...
                      <div className="slide-content p-absolute  ">
                        <div className="content p-relative">
                          ...
                          <div className="d-block" />
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project2.html" className="effect-ajax" data-dsn-ajax="slider">Yaren collection</a>
                          </h1>
                          <hr className="mt-20" />
                    ...
                    <div className="slide-item swiper-slide over-hidden">
                      ...
                      <div className="slide-content p-absolute  ">
                        <div className="content p-relative">
                          ...
                          <div className="d-block" />
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project3.html" className="effect-ajax" data-dsn-ajax="slider">Huggl Power Pack</a>
                          </h1>
                          <hr className="mt-20" />
                    ...
                    <div className="slide-item swiper-slide over-hidden">
                      ...
                      <div className="slide-content p-absolute  ">
                        <div className="content p-relative">
                          ...
                          <div className="d-block" />
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project4.html" className="effect-ajax" data-dsn-ajax="slider">Principal Garden</a>
                          </h1>
                          <hr className="mt-20" />
                          <p className="max-w570 mt-20 description ">Huggl is an induction
                            charging.</p>
                    ...
                    <div className="slide-item swiper-slide over-hidden">
                      ...
                      <div className="slide-content p-absolute  ">
                        <div className="content p-relative">
                          ...
                          <div className="d-block" />
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project5.html" className="effect-ajax" data-dsn-ajax="slider">Small Silver Car</a>
                          </h1>
                          <hr className="mt-20" />
                          <p className="max-w570 mt-20 description ">Huggl is an induction
                            charging.</p>
                    ...
                    <div className="slide-item swiper-slide over-hidden">
                      ...
                      <div className="slide-content p-absolute  ">
                        <div className="content p-relative">
                          ...
                          <div className="d-block" />
                          <h1 className="title user-no-selection d-inline-block ">
                            <a href="project6.html" className="effect-ajax" data-dsn-ajax="slider">Lengshuikeng</a>
                          </h1>
                          <hr className="mt-20" />
              ...
              <div className="dsn-slider-content p-absolute h-100 w-100 ">
                <div className="dsn-container d-flex align-items-end " />
              </div>
            </div>
            ...
            <div id="dsn-scrollbar">
              <div className="main-content">
                <div className="wrapper">
                          ...
                          <div className="box-info pt-60 pb-60">
                            ...
                            <div className="d-flex flex-column align-items-start ">
                              <div className="section-title">
                                ...
                                <p className="sub-heading line-bg-left mt-20 dsn-up">
                                  Digital Artisit
                                </p>
                              </div>
                            </div>
                  ...
                  {/* ========== End About Section ========== */}
                  {/* ========== Service Section ========== */}
                  <section className="services with-line with-number p-relative section-margin dsn-col" data-dsn-title="Our Services">
                    ...
                    <div className="container">
                      <div className=" grid dsn-isotope dsn-col">
                        <div className="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
                    ...
                    <div className="swiper-container">
                      <div className="swiper-wrapper v-dark-head">
                        <div className="swiper-slide over-hidden work-item">
                          ...
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            <div className="metas d-inline-block mb-15">
                              <span>Photography</span> <span> car</span>
                            </div>
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project5.html">
                                Small Silver Car
                              </a>
                            </h4>
                          </div>
                        ...
                        <div className="swiper-slide over-hidden work-item">
                          <div className="box-img p-relative over-hidden before-z-index" data-overlay={6} data-swiper-parallax-scale="0.85">
                            <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/1.jpg" alt="" />
                          </div>
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            <div className="metas d-inline-block mb-15">
                            ...
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project3.html">
                                Huggl Power Pack</a>
                            </h4>
                          </div>
                        </div>
                        <div className="swiper-slide over-hidden work-item">
                          <div className="box-img p-relative over-hidden before-z-index" data-overlay={4} data-swiper-parallax-scale="0.85">
                            <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project6/1.jpg" alt="" />
                          </div>
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            <div className="metas d-inline-block mb-15">
                            ...
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project6.html">Lengshuikeng</a>
                            </h4>
                          </div>
                        </div>
                        <div className="swiper-slide over-hidden work-item">
                          ...
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            ...
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project1.html">Maybe
                                speaker</a>
                            </h4>
                          </div>
                        </div>
                        <div className="swiper-slide over-hidden work-item">
                          ...
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            ...
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project2.html">
                                Yaren collection</a>
                            </h4>
                          </div>
                        </div>
                        <div className="swiper-slide over-hidden work-item">
                          <div className="box-img p-relative over-hidden before-z-index" data-overlay={2} data-swiper-parallax-scale="0.85">
                            <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project4/1.jpg" alt="" />
                          </div>
                          <div className="box-content" data-swiper-parallax-opacity={0}>
                            <div className="metas d-inline-block mb-15">
                            ...
                            <h4 className="sec-title">
                              <a className="effect-ajax" data-dsn-ajax="work" href="project4.html">
                                Principal Garden</a>
                            </h4>
                          </div>
                        </div>
                  ...
                  {/* ========== End Work Section ========== */}
                  {/* ========== testimonial Section ========== */}
                  <section className="testimonials testimonials-half section-margin" data-dsn-title="testimonials">
                    <div className="container">
                      <div className="testimonials-box box-padding p-relative w-100 background-section">
                        <div className="row">
                          ...
                          <div className="col-lg-8">
                            <div className="testimonials-inner p-relative text-left dsn-swiper " data-dsn-controller=".testimonial-content" data-dsn-option="{&quot;slidesPerView&quot;:2,&quot;spaceBetween&quot;:50,&quot;centeredSlides&quot;:false }">
                      ...
                      <div className="swiper-container">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide blog-classic-item">
                            <div className=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                              <div className="box-meta">
                                <div className="entry-date">
                                  <span className="author">Dsn Grid</span>
                                  <a href="#">March , 17th 2020</a>
                                </div>
                              </div>
                              <div className="box-img over-hidden">
                                <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/1.jpg" alt="" />
                              </div>
                              <div className="box-content p-relative">
                                <div className="box-content-body">
                                  <div className="metas">
                                    <span className="mb-5">Lifestyle</span>
                                  </div>
                                  ...
                                  <p>Whoever said “It’s not about the destination. It’s the journey”
                                    never
                                    flew on a long ...</p>
                                  <a href="#" className="link-vist p-relative mt-20">
                          ...
                          <div className="swiper-slide blog-classic-item">
                            <div className=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                              ...
                              <div className="box-img over-hidden">
                                <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/2.jpg" alt="" />
                              </div>
                              <div className="box-content p-relative">
                                <div className="box-content-body">
                                  <div className="metas">
                                    <span className="mb-5">Travel</span>
                                  </div>
                                  <h4 className="title-block mb-20">
                          ...
                          <div className="swiper-slide blog-classic-item">
                            <div className=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                              ...
                              <div className="box-img over-hidden">
                                <img className="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/3.jpg" alt="" />
                              </div>
                              <div className="box-content p-relative">
                                <div className="box-content-body">
                                  <div className="metas">
                                    <span className="mb-5">Health</span>
                                  </div>
                                  <h4 className="title-block mb-20">
                  ...
                  <section className="team section-margin p-relative" data-dsn-animate="section" data-dsn-title="our team">
                    ...
                    <div className="container">
                      <div className="d-grid grid-lg-3 grid-sm-2 dsn-up">
                            ...
                            <div className="team-item-wapper background-section">
                              <div className="item-content d-flex a-item-center">
                                ...
                                <div className="box-text">
                                  <h4 className="sm-title-block mb-5">Ahmed Shawky</h4>
                          ...
                          <div className="team-item-inner">
                            <div className="team-item-wapper background-section">
                              <div className="item-content d-flex a-item-center">
                                ...
                                <div className="box-text">
                                  <h4 className="sm-title-block mb-5">Jeremy Smith</h4>
                                  <h5 className="theme-color">Creative Studio Head</h5>
                                  <ul className="box-social mt-20">
                                    <li data-dsn="parallax"><a href="#">FB</a></li>
                                    <li data-dsn="parallax"><a href="#">TW</a></li>
                                    <li data-dsn="parallax"><a href="#">LN</a></li>
                          ...
                          <div className="team-item-inner">
                            <div className="team-item-wapper background-section">
                              <div className="item-content d-flex a-item-center">
                                ...
                                <div className="box-text">
                                  <h4 className="sm-title-block mb-5">Angelo Walking</h4>
                                  <h5 className="theme-color">Developer Lead</h5>
                                  <ul className="box-social mt-20">
                                    <li data-dsn="parallax"><a href="#">FB</a></li>
                                    <li data-dsn="parallax"><a href="#">TW</a></li>
                                    <li data-dsn="parallax"><a href="#">LN</a></li>
                  ...
                  <section className="brand-client section-margin" data-dsn-animate="section" data-dsn-title="our clients">
                    <div className="container mb-70 d-flex text-center flex-column  align-items-center">
                      <p className="sub-heading line-shap line-shap-before mb-15">
                        <span className="line-bg-right">
                          Our clients
                    ...
                    <div className="container">
                      <div className="wrapper-client dsn-up">
